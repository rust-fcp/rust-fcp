...
fn setup_nodes() -> (PublicKey, MockPlumbing, PublicKey, MockPlumbing, PublicKey, MockPlumbing) {
    ...
    let sk3 = SecretKey::from_hex(b"3e620844d1343a2e557110238c4ab19eee44ca0cb7654cef50dea82e59bd2ce2").unwrap();
    let pk3 = PublicKey::from_base32(b"0gqdmv240dd33zrm1w44x0k99nf5sk8xkwgyvwwv4tgxj9v7tdm0.k").unwrap();
